...
<html lang="en">
  ...
  <body>
      <h2 class="mr-3">Category List</h2>
        ...
        <tbody>
            <?php
                ...
                if($get_categories){
                    ...
                    echo "<td>
                    <a href='edit_category.php?category_id=$id' class='btn btn-info btn-sm'>Edit</a>";
                    ?>
                    <a href='category_action.php?action=delete&category_id=<?php echo $id; ?>'
